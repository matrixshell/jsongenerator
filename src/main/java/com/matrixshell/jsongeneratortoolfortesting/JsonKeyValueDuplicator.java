...
@Slf4j
public class JsonKeyValueDuplicator {
	 ...
	 *                               in an array
	 */
	public JsonKeyValueDuplicator(boolean completeArrDuplication) {
	 ...
	 *                               duplication.
	 */
	public JsonKeyValueDuplicator(boolean completeArrDuplication, int levels) {
		this.completeArrDuplication = completeArrDuplication;
		this.levels = Optional.of(levels - 1);
	}
